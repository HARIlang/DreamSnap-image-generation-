...
<div className="p-4 max-w-md w-full mx-auto mt-10">
  <div className="w-full aspect-[1/1] flex items-center justify-center rounded overflow-hidden">
    {loading ? (
      <div className="w-full h-full rounded animate-gradientMove bg-gradient-to-r from-pink-300 via-fuchsia-300 to-rose-300" />
    ) : (
      imageUrl && (
        <div className="w-full mt-4 border-2 border-white">
          <img
            src={imageUrl}
            alt="Generated"
            className="w-full h-auto rounded shadow-lg mb-2 object-cover"
          />
        </div>
      )
    )}
